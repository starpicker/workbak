...
MRESULT	AMCM_GetGlobalData(MHandle hCMgr, MDWord id, MVoid* pBuf, MInt32 lLen); 

MRESULT AMCM_GetGlobalDataPtr(MHandle hCMgr, MDWord id, MVoid** ppBuf, MInt32 lLen);

MRESULT	AMCM_SetGlobalData(MHandle hCMgr, MDWord id, MVoid* pBuf, MInt32 lLen);
