...
#define	MPP_DIRECTION_ROTATE_90				(MPP_DIRECTION_TRANSPOSE | MPP_DIRECTION_FLIP_HORIZONTAL)		//Rotate 90бу CW
#define	MPP_DIRECTION_ROTATE_180			(MPP_DIRECTION_FLIP_VERTICAL | MPP_DIRECTION_FLIP_HORIZONTAL)	//Rotate 180
#define	MPP_DIRECTION_ROTATE_270			(MPP_DIRECTION_TRANSPOSE | MPP_DIRECTION_FLIP_VERTICAL)			//Rotate 270бу CW
