...
PLATFORM_EXPORT
MRESULT MImgGetFileInfo(MHandle hCMgr, HMSTREAM hStream, MDWord* pdwFileFormat, MSIZE* psizeFile, MDWord* pdwFileSubformat, MLong* plBitCount);

PLATFORM_EXPORT
MRESULT MImgGetFileInfoWithFileName(MHandle hCMgr, HMSTREAM hStream, MTChar *pszFileName, MDWord* pdwFileFormat, 
									MSIZE* psizeFile, MDWord* pdwFileSubformat, MLong* plBitCount);
...
typedef struct tagAM_ENCODE_INITPARAM
{
	...
	MLong		lXPelsPerMeter;
	MLong		lYPelsPerMeter;
