...
{
	MLong	lHighLight ;//0-100
	MLong	lContrast;//0-100
	MLong	lDark;//0-100
	MLong	lSaturation;//0-100
	MLong	lComplexion;//0-100
}ReversalFilmPARAM;
...
{
	MLong lBrightness;//-150~150
	MLong lContrast;// -100~100
...
{
	MLong lSaturation;//-100~100
}SaturationPARAM;

typedef struct __tag_definition
{
	MLong 	lRadius;//>0; change with width of image
	MLong lThreshold;//0~100
	MLong lStrength;//-100~100
}DefinitionPARAM;

typedef struct __tag_highlightbrightdarkshadow
{
	MLong lHighlight;//-100~100
	MLong lShadow;//-100~100
	MLong lBrightColor;//-100~100
	MLong lDarkColor;//-100~100
	MLong lRight;//reserve
	MLong lLeft;//reserve
	MLong lMid;//reserve
	MByte *bOutputTable;//output 256 curve of rgb 
...
{
	MLong lHighHue;//0~360
	MLong lHighSatu;//0~100
	MLong lBalance;//-100~100
	MLong lShadowHue;//0~360
	MLong lShadowSatu;//0~100
}SeparateTonePARAM;
